...
#warning env_pop_context
int env_pop_context(void)
{
}

#warning env_push_context
...
#define PATH_MAX 255
#define CONFIG_PROMPT "hush:"
#define CONFIG_PROMPT_HUSH_PS2 ">"
#define CONFIG_CBSIZE 512
...
# endif
	...
	if (!strcmp(globbuf.gl_pathv[0], "getopt")) {
		...
		printf("execute_binfmt(globbuf.gl_pathv[0]=%s)\n", globbuf.gl_pathv[0]);
		ret = 0;
		#warning execute_binfmt
		#if 0
...
static int binfmt_sh_excute(char *file, int argc, char **argv)
{
